...
import {exitTeam} from '../../../reducks/team/operations'
...
const decision = () => {
    ...
    <div>
        ...
        >
            <DialogTitle id="form-dialog-title">下記のチームから退会します。</DialogTitle>
